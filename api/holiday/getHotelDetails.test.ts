...
describe('getHotelDetails', () => {
    ...
    it('throws an error when the API call fails', async () => {
        ...
        await expect(getHotelDetails({
            "type": "ebfhufu",
            "username": "ifrewjofjf",
            "application_name": "njdwiduwi",
            "client_id": "hudqwduiqhduiqw",
            "token_type": "uifehfhwuf",
            "access_token": "dgwuigduudfiehuideghuid",
            "expires_in": 8799,
            "state": "ahdoidhoiwhodihw",
            "scope": "wkjodjoqwijdoiqewjdoiqe"
        }, ["njeiijw"], "2024-05-05", "2024-05-17")).rejects.toThrow();
    });
